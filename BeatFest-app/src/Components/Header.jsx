...
const Header = () => {
  ...
  return (
    <header className="bg-black text-gray-100 py-6 px-4 relative flex items-center justify-center md:py-4">
...
//   return (
//     <header className="bg-black text-gray-100 p-4 relative flex items-center justify-center">
//       <Link to="/" className="absolute left-4 md:left-0 z-10">
//         <img src="../src/assets/HeaderLogoBeatFest.png" alt="Beat Fest Logo" className="h-8 md:h-12" />
//       </Link>

//       <button className="text-gray-100 md:hidden z-30" onClick={() => setIsOpen(!isOpen)} style={{ position: 'absolute', right: '1rem', top: '1rem' }}>
//         <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
//           <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h16M4 18h16"></path>
//         </svg>
//       </button>
...
//   return (
//     <header className="bg-black text-gray-100 p-4 relative flex items-center justify-between">
//       <Link to="/" className="z-10">
//         <img src="../src/assets/HeaderLogoBeatFest.png" alt="Beat Fest Logo" className="h-8 md:h-12" />
//       </Link>

//       {/* Mobile Navigation */}
//       <button className="text-gray-100 md:hidden z-30" onClick={() => setIsOpen(!isOpen)}>
